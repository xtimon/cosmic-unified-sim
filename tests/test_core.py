...
class TestExceptions:
    ...
    def test_quantum_error(self):
        ...
        from sim.core.exceptions import (
            QuantumError, InvalidQubitIndexError, InvalidQuantumStateError
        )
    ...
    def test_cosmic_error(self):
        ...
        from sim.core.exceptions import (
            CosmicError, NoBodiesError, CollisionError
        )
...
class TestConfig:
    ...
    def test_config_from_dict(self):
        ...
        data = {
            "quantum": {"num_qubits": 5},
            "cosmic": {"integrator": "verlet"}
        }
    ...
    def test_global_config(self):
        ...
        from sim.core.config import get_config, set_config, reset_config, SimulationConfig
...
class TestLogging:
    ...
    def test_setup_logging(self):
        """Test logging setup."""
        from sim.core.logging import setup_logging, logger
        import logging
