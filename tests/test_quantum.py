...
class TestQuantumOperators:
    ...
    def test_cnot_sparse(self):
        ...
        # CNOT truth table
        assert_allclose(cnot @ [1, 0, 0, 0], [1, 0, 0, 0])  # |00> -> |00>
        assert_allclose(cnot @ [0, 1, 0, 0], [0, 1, 0, 0])  # |01> -> |01>
        assert_allclose(cnot @ [0, 0, 1, 0], [0, 0, 0, 1])  # |10> -> |11>
        assert_allclose(cnot @ [0, 0, 0, 1], [0, 0, 1, 0])  # |11> -> |10>
    ...
    def test_operator_cache(self):
        ...
        from sim.quantum.operators import build_cnot_sparse, get_cache_stats, clear_cache
