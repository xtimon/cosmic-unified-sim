...
class TestBody:
    ...
    def test_body_state(self):
        ...
        new_state = {
            ...
            "velocity": np.array([40, 50, 60])
        }
        body.set_state(new_state)
        
        assert_array_equal(body.position, [10, 20, 30])
        assert_array_equal(body.velocity, [40, 50, 60])
...
class TestNBodySimulator:
    ...
    def test_add_remove_body(self):
        ...
        from sim.cosmic import NBodySimulator, Body
...
class TestIntegrators:
    ...
    def test_verlet_integrator(self):
        ...
        from sim.cosmic.integrators import VerletIntegrator, IntegratorState
    ...
    def test_yoshida_integrator(self):
        ...
        from sim.cosmic.integrators import Yoshida4Integrator, IntegratorState
