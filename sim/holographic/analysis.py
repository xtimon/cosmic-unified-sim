...
COSMOLOGICAL_MODELS = {
    'Planck2018': CosmologicalModel(
        name='Planck 2018',
        H0=67.36, Omega_m=0.315, Omega_b=0.0493,
        Omega_lambda=0.685, A_s=2.100e-9, n_s=0.9649, sigma_8=0.811
    ),
    'WMAP9': CosmologicalModel(
        name='WMAP9',
        H0=69.32, Omega_m=0.287, Omega_b=0.0463,
        Omega_lambda=0.713, A_s=2.195e-9, n_s=0.9608, sigma_8=0.820
    ),
    'SH0ES': CosmologicalModel(
        name='SH0ES',
        H0=73.04, Omega_m=0.300, Omega_b=0.0490,
        Omega_lambda=0.700, A_s=2.100e-9, n_s=0.9649, sigma_8=0.811
    ),
    'DES': CosmologicalModel(
        name='DES',
        H0=67.4, Omega_m=0.339, Omega_b=0.0490,
        Omega_lambda=0.661, A_s=2.100e-9, n_s=0.9649, sigma_8=0.733
    ),
    'ACT': CosmologicalModel(
        name='ACT',
        H0=67.9, Omega_m=0.306, Omega_b=0.0490,
        Omega_lambda=0.694, A_s=2.100e-9, n_s=0.9649, sigma_8=0.840
    ),
}
...
class HolographicAnalysis:
    ...
    def formula_comparison(self) -> Dict:
        ...
        errors = {
            ...
            for name, k in formulas.items() if name != 'observed'
        }
    ...
    def information_capacity(
        self,
        horizon_radius: float = 4.4e26  # meters (observable universe)
    ) -> Dict:
        """
