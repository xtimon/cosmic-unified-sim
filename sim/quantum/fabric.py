...
from sim.core.gpu import get_backend, GPUBackend
...
class QuantumFabric:
    ...
    def __init__(self, num_qubits: int, entanglement_strength: float = 1.0,
        ...
        if not 0.0 <= entanglement_strength <= 1.0:
            raise ValueError(f"entanglement_strength must be in [0, 1], got {entanglement_strength}")
    ...
    def get_state_info(self) -> str:
        ...
        return (f"System of {self.n} qubits, "
